...
typedef struct {
  ...
  /* ── E2SM-RC Style 2: Per-UE PRB quota set by xApp via RC Control ── */
  uint8_t  rc_min_prb_pct;    /* minimum guaranteed PRB share  0-100 */
  uint8_t  rc_max_prb_pct;    /* maximum allowed PRB share     0-100 */
  bool     rc_prb_quota_set;  /* false = unconstrained (default)     */
} NR_UE_sched_ctrl_t;
